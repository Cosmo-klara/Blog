...
感觉 EchoingPixels 这个做的已经挺完善了，在音视频直接融合上面，要做或者从音频出发？因为 LongVALE 的特点就是引入了音频影响事件边界，或者从音频 token 压缩入手去引导视频 token 的压缩？


### 2025-01-05 - 2025-01-06

+ new baseline：独立不相干的 视觉 token 压缩和音频 token 压缩
