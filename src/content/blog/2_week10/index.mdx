...
|模型       & $p_{llm}$     & Token 预算    & FLOPs(T)$\downarrow$  & 总体准确率$\uparrow$ \\ \midrule

|:---: |:---: |:---: |:---: |:---: |
|完整模型    &  —            & 100\%           & 100.69    & 46.00  \\
Dycoke      &  —            & 50\%            & 81.81     & 43.66  \\
Omnizip     &  —            & 45\%            & 72.04     & 45.37  \\
\rowcolor{lightgray} Ours   & 50\%          & 67\% / 33.5\%   & 70.11     & 45.52  \\
\rowcolor{lightgray} Ours   & 40\%          & 67\% / 26.8\%   & 67.82     & 45.46  \\
\rowcolor{lightgray} Ours   & 30\%          & 67\% / 20.1\%   & 65.55     & 45.21  \\ \bottomrule
