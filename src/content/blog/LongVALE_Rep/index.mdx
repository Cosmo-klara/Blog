...
python longvalellm/eval/eval.py --data_path longvale-annotations-eval.json --video_feat_folder features_eval/visual_features_1171 --audio_feat_folder features_eval/audio_features_1171 --asr_feat_folder features_eval/speech_features_1171 --task all --log_path log
